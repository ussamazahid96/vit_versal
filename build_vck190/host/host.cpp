...
int main(int argc, char** argv) {
    char* xclbinFilename="mm_hw.xclbin";
    int iter=1;
    if(argc == 3) {
    ...
    double mm_time = 0, ln_time = 0, sm_time = 0, gl_time = 0, rt_time = 0, OPS = 0, emb_time = 0;
    Timer tmr, tmr2;
    for(int i=0; i<NUM_LARYERS;i++) {
    ...
    std::cout << "Pre-Processing   time = " << emb_time <<  "s/image\n";
